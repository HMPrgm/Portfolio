...
export default function Hero() {
  ...
  return (
    <section id="home" className="items-center text-center bw-text font-playfairDisplay flex flex-col gap-12 min-h-screen justify-center ">
      ...
      <ReactTyped strings={['A CS student at UVA', 'A Full-Stack Developer', 'An AI Engineer']} typeSpeed={100} backSpeed={100} startDelay={3000} backDelay={1000} cursorChar='' loop/>
