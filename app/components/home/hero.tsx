...
export default function Hero() {
  ...
  return (
    <section id="home" className="items-center text-center bw-text font-playfairDisplay flex flex-col gap-12 min-h-screen justify-center ">
      ...
      <ReactTyped strings={['Hi, I\'m Henry']} typeSpeed={80} cursorChar=''/>
      </h2>
      <h3 className="text-4xl min-h-10">
      <ReactTyped strings={['A CS student at UVA', 'A Full-Stack Developer', 'An AI Engineer']} typeSpeed={100} backSpeed={50} startDelay={1000} backDelay={1000} cursorChar='' loop/>
