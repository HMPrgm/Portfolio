...
export default function About() {
  ...
  return (
    <section className="bw-text flex flex-col justify-center text-center py-10">
        <h2 className="font-playfairDisplay text-5xl pb-10">Who Am I?</h2>
        {sections.map(s=> <About_section title={s.title} text={s.text} left={s.left}></About_section>)}
    </section>
  )
}
