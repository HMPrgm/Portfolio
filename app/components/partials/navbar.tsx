...
export default function Navbar() {
    ...
    return (
        <nav className="container items-center flex mx-auto justify-center invisible  sm:visible">
            <div className={`flex justify-center fixed px-4 rounded-full nav-links font-bold text-lg bw-text bg-white dark:bg-[#131920] duration-500 ease-out ${isScrolled ? 'bg-opacity-75 mt-24 gap-4 py-2' : 'bg-opacity-0 mt-32 gap-8 py-3 '} drop-shadow-sm `}>
